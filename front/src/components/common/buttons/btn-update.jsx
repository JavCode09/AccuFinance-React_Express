...
const ButtonUpdate = ({ModalCategoriesUpdate,category,getDataUpdate, size}) => {
    ...
    return ( 
        <>
           <div className="btn_update">
            <Button className='btn_update btn btn-warning'  size={size}  onClick={showModal_Update}>Actualizar</Button>
            </div>
