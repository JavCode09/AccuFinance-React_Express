...
const ButtonDelete = ({ModalCategoriesDelete,category, getDataDelete,  size }) => {
    ...
    return ( 
        <>
            <div className="btn_delete">
                <Button className='btn_delete btn btn-danger'  size={size}  onClick={showModalDelete}>Eliminar</Button>
            </div>
