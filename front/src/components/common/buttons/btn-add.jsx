...
const ButtonAdd = ({ModalComponent,category, getData,size,styleColor, value, onRefreshOtro}) => {
    ...
    return ( 
       <>
            <div className="btn_add">
                <Button  className={`btn_add btn btn-${buttonColor}`} size={size} onClick={showModal}>{value}</Button>
            </div>
